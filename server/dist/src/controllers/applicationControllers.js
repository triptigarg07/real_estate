...
const listApplications = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const formattedApplications = yield Promise.all(applications.map((app) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            return Object.assign(Object.assign({}, app), { property: Object.assign(Object.assign({}, app.property), { address: app.property.location.address }), manager: app.property.manager, lease: lease ? Object.assign(Object.assign({}, lease), { nextPaymentDate: calculateNextPaymentDate(lease.startDate) }) : null });
        })));
...
const createApplication = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!property) {
            res.status(404).json({ message: "Propery not found" });
            return;
        }
        ...
        res
            .status(500)
            .json({ message: `Error creating applicaion: ${error.message}` });
    }
});
